...
$("#add_agr_document form[name='doc_upload']").on('beforeSubmit', function(e) {
...
$("#add_mission_document form[name='doc_upload']").on('beforeSubmit', function(e) {

    var url = $('#document-mission-upload').data('url');
    var formData = new FormData($(this)[0]);
